...
char sw_1_mem, sw_2_mem,counter ;
...
/*************************************************************************************************************/
ISR(PCINT2_vect) {                                                    //ISR for sw1 and 2
Timer_T0_10mS_delay_x_m(5);                                           //switch bounce delay
clear_PCI_on_sw1_and_sw2;                                             //clear spurious interrupt flags
String_to_PC("PCINT2: ");

if((switch_1_up) && (switch_2_up)){                                   //interrupt for switch release
if (sw_1_mem == 'D')String_to_PC("switch_1_released\r\n");            //determine which switch has been released
if (sw_2_mem == 'D')String_to_PC("switch_2_released\r\n");
sw_1_mem = 'U';sw_2_mem = 'U';}                                       //set previous sw position to up.

else                                                                  //interrupt for switch press
{if (switch_1_down)
{String_to_PC("switch_1_pressed\r\n");sw_1_mem = 'D';}
if (switch_2_down)
{String_to_PC("switch_2_pressed\r\n");sw_2_mem = 'D';}}
clear_PCI_on_sw1_and_sw2;}                                             //clear spurious interrupts due to switch bounce



/*************************************************************************************************************/
ISR(PCINT0_vect) {                                                    //ISR for sw3
Timer_T0_10mS_delay_x_m(5);                                           //switch bounce delay
clear_PCI_on_sw3;                                                     //clear spurious interrupt flags
String_to_PC("PCINT0: ");
if(switch_3_down)String_to_PC("switch_3_pressed\r\n");                //sw3 pressed 
else String_to_PC("switch_3 released\r\n");                           //sw3 released
clear_PCI_on_sw3;}                                                    //clear spurious interrupts due to switch bounce
...
case '1': hold_PCI_on_sw1_and_sw2;String_to_PC(message_cases_1_and_5);String_to_PC("sw1_and_sw2\r\n");break;
case '2': restore_PCI_on_sw1_and_sw2;String_to_PC(message_cases_2_and_6);String_to_PC("sw1_and_sw2\r\n");break;
case '3': disable_pci_on_sw1_and_sw2;String_to_PC(message_cases_3_and_7);String_to_PC("sw1_and_sw2\r\n");break;
case '4': enable_pci_on_sw1_and_sw2;String_to_PC(message_cases_4_and_8);String_to_PC("sw1_and_sw2\r\n");break;

case '5': hold_PCI_on_sw3;String_to_PC(message_cases_1_and_5);String_to_PC("sw3\r\n");break;
case '6': restore_PCI_on_sw3;String_to_PC(message_cases_2_and_6);String_to_PC("sw3\r\n");break;
case '7': disable_pci_on_sw3;String_to_PC(message_cases_3_and_7);String_to_PC("sw3\r\n");break;
case '8': enable_pci_on_sw3;String_to_PC(message_cases_4_and_8);String_to_PC("sw3\r\n");break;
...
case 'c': if(PCIenabled){String_to_PC("Status: PCI enabled ");
      if(pci_on_sw1_and_sw2_disabled)String_to_PC("but PCI on sw1 and sw2 disabled ");
      if(pci_on_sw3_disabled)String_to_PC("but PCI on sw3 disabled ");}
      else String_to_PC("Status: PCI dissabled  ");
      
      if(PCIset_up){String_to_PC("\r\nStatus: PCI setup ");
      if(PCI_on_sw1_and_sw2_on_hold)String_to_PC("but PCI on sw1 and sw2 placed on hold\r\n");
      if(PCI_on_sw3_on_hold)String_to_PC("but PCI on sw3 placed on hold\r\n");}
