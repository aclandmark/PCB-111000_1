...
Arduino appears to struggle with the £ symbol which does not appear in the firt 127 chars of the ASCII code
...
/**************************************************************************************************/
long inc_num(long Num_1, unsigned char op){                     //Some basic arithmetic
switch(op){
...
case 163: Num_1 = Num_1 - 3; break;                             //£ symbol generates code 163 on some PCs.
