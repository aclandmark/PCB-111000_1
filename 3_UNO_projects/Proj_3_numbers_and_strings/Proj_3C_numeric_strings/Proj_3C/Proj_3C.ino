...
setup_UNO;
User_prompt;
const char *num_string_1 = "67108864";                      //"num_string_1" is a pointer to an array containing chars 6,7,1,0,8,8,6,4
...
/**************************************************************************************************/
long AtoB_local(const char array[]){                        //Local function only
long num=0; int m=0;
...
/**************************************************************************************************/
void NumericString_to_PC_local(const char* s){              //Local function only
int n=0;
...
/**************************************************************************************************/
void NumericString_to_display_R_local(const char array[]){
char reverse_array[9];
int n=0;
for(int m = 0; m<=8; m++)reverse_array[m]=0;                //Once again scan through the string to find the null character
while (array[n] != '\0')n++;
for(int m = n; m; m--)
reverse_array[n-m] = *(array + m-1);                        //Copy symbols to a new array starting with the final symbol and ending with the first
