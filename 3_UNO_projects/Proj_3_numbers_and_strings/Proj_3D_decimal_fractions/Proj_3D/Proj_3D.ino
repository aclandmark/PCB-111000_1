...
const char * message_ptr[6];

const char *num_string_1 = "537";                               //define a number of messages
const char *num_string_2 = "1379";
const char text_1[] = " divided by ";
const char text_2[] = " equals ";
const char *num_string_3 = "58";
const char *num_string_4 = "124";
