...
The main difference between "isCharavailable(m)” and "waitforkeypres()" is that the former can be used with the WDTimer
(see Proj_2H) and the latter cannot, it simply brings program execution to a halt barring interrupts.
