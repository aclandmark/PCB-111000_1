...
Press and hold sw2 to scroll through prime numbers from 0 to 200.
Pulse sw3 to increase start point by 200.
...
if((mode == 0) && (switch_2_up))return;
if((mode == 0) && (switch_2_down))
{mode = 2; return;}                                     //Press SW2 to resume scanning (mode = 2)
if((mode==2) && (switch_2_up))  
{mode = 0; return;}}                                    //Release SW2 to pause scanning (mode = 0)
...
ISR (PCINT0_vect){
int j;
if(switch_3_up) return;               //Ignore sw3 release
