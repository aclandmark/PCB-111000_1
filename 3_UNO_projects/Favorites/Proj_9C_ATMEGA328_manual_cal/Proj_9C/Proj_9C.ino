...
/*This project generates a print out of calibration error as a function of the calibration
...
This causes the mini-OS to carry out manual calibration of the pcb_a ATMEGA 328.

Calibration relies on the fact that an 8MHz clock counts up to 62,500 every 7.8125mS 
an interval easily generated by a timer, controlled using a watch crystal.   
