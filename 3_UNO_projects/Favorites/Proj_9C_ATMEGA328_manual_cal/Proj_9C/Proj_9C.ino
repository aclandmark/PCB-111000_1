...
/*calibration of UNO mini_OS needs bringing into line with that of PCB 111000_V2*/

unsigned char Decimal_from_KBD(void);
...
Test_res = 132;Num_to_PC(10, Test_res); newline();
