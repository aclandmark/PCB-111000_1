...
if((switch_1_down) || (switch_2_down))break;                     //if sw1 or sw2 down break
...
char copy_of_SREG;            
config_sw1_and_sw2_for_PCI;                                     //Enable pci on sw1 and sw3
config_sw3_for_PCI;                                             //Enable pci on sw2
...
if (switch_3_down){digits[0] = 'P';                             //Pulse sw2 to set digit[0] to P (decimal point)
