...
The following project resources are introduced:
  I2C_Tx_any_segment(segment, digit_num);
  I2C_Tx_any_segment_clear_all();
  PRN_16bit_GEN (0) Pseudo Random Number Generator
    As a result of the zero PRN values are taken
    from the EEPROM and saved to it.  
*/
