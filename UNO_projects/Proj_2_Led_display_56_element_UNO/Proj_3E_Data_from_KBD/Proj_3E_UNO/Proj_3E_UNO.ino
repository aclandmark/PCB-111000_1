...
setup_HW;
User_prompt;
if(User_response == 'r')mode = 1; else mode = 0;                             //User response is defined in "Basic_HW_setup"
...
unsigned char keypress;                                                                //library version does not.
...
I2C_Tx_float_num(Numerator,exp);
