...
{eeprom_write_byte((uint8_t*)0x3FC, 0x2);							//Reset flag
...
if(eeprom_read_byte((uint8_t*)0x3FC)  == 2){						//Read Arduino code from new UNO pcb
...
phys_address = 0x2E48;  											//Verify Hex_text_bootloader code.
read_ops=0; 
