...
default: 
		...
		read_flash ();
		if (Flash_readout == 0xFF)asm("jmp 0x5E80");
...
address_in_flash = 0x5E7E;											//First character will be storred at 0x5FFF not 0xFFE
...
if (!((0x5E7E - address_in_flash)%128)){							//If page buffer is full
...
if((0x5E7E - address_in_flash)%128){								//Write remaining chars in partialy full page buffer
address_in_flash += (0x5E7E - address_in_flash)%128 - 126;			//Get address of first character in the page
