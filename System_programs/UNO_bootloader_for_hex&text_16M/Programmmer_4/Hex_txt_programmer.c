...
default: 
		...
		read_flash ();
		if (Flash_readout == 0xFF)asm("jmp 0x5F80");
		else asm("jmp 0x0000");break;}
...
if (!((0x5F7E - address_in_flash)%128)){							//If page buffer is full
...
if((0x5F7E - address_in_flash)%128){								//Write remaining chars in partialy full page buffer
address_in_flash += (0x5F7E - address_in_flash)%128 - 126;			//Get address of first character in the page
