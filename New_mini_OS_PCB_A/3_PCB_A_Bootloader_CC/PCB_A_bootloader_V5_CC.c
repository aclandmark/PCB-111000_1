...
{eeprom_write_byte((uint8_t*)0x3F9,1);					//FOR POR, BOR or WDTime out or immediatelt after 
...
wdt_enable(WDTO_30MS); while(1);}						//effect and control jumps to location zero
