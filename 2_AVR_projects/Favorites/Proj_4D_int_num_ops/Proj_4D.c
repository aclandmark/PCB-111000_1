...
A program that calculates roots and powers of integer numbers.
...
/****************************************************************************************************************/
ISR(PCINT0_vect){int_arithmetic_sw3_isr();}
...
case 2: disable_pci_on_sw3; break;}						//Data entry is complete. Disable pci on sw2.
...
}while(switch_3_down);									//Continue while sw2 is down

Timer_T0_10mS_delay_x_m(50);							//wait 500ms after sw2 has been released
if(switch_3_up)break;}									//if sw2_down again continue scrolling the digit
