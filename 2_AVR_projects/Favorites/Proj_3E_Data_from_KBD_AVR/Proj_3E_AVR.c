...
Num_1 = Num_from_KBD_Local(digits);                                         //Acquires data from keyboard

do{
Num_to_PC(10,++counter); Char_to_PC('\t');Num_to_PC(10,Num_1); newline();   //Converts numbers strings and sends them to the pc.
...
Num_to_PC(10,--counter); Char_to_PC('\t');Num_to_PC(10,Num_1); newline();                                             
I2C_Tx_long(Num_1);
