...
SW1 and 2 call ISR(PCINT2_vect)
SW3 calls ISR(PCINT0_vect)*/
...
if(switch_2_down)num *=10;                                        //If sw2 was pressed multiply the number by 8
...
while(switch_2_down){                                            //Use switch 1 to select keypress 0...9
