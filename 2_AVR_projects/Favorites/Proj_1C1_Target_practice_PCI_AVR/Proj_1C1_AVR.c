...
//Proj_1C:  Target practice: Testing your reaction time
...
volatile unsigned int PORT_1;		        	//Variables used by both the main routine and also by the Interrupt Service Routine 
volatile unsigned int mask;						//"mask" is continuously adjusted as LEDs are shot down
